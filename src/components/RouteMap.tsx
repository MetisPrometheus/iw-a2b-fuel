...
export default function RouteMap({ stops, geometry, mapboxToken }: Props) {
  if (!mapboxToken) {
    return (
      <div className="glass rounded-xl h-full min-h-72 flex items-center justify-center text-center p-6">
  ...
  return (
    <div className="glass rounded-xl overflow-hidden h-full min-h-72">
